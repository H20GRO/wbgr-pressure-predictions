...
class PressurePoint:
    ...
    def post_processing(self) -> None:
        ...
        self.df_bandwith_parameter_set.to_parquet(f'{RESULTS_DIR}/{self.Name}_bandwith_parameter_set.parquet')
    ...
    def plot_bandwidth(self) -> None:
        ...
        fig.add_trace(go.Scatter(x= self.predicted_y.index,y=self.predicted_y, name='Verwachting', line_color='blue'))
        ...
        fig.update_layout(yaxis_title="<b>Druk (kPa) </b>",
          title={
        'text': f"<b>Drukbandbreedte bij {self.Name} </b>",
        'y':0.95,
        'x':0.5,
        'xanchor': 'center',
        'yanchor': 'top'}
